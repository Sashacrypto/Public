...
- ID: P-001, P-002, ... (последовательно)
- Acceptance criteria: проверяемые пункты выполнения задачи
- Status: ✅ Done (после коммита)
- Notes: краткое объяснение "зачем это нужно"
